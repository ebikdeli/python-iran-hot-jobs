...
def into_csv(data:dict, url:str) -> bool:
    ...
    try:
        ...
        fields = ['title', 'url', 'company_name', 'company_link',
                'salary', 'experience', 'age', 'gender',
                'language', 'skills', 'education', 'description']
        data_row = [data['title'], url, data['company_name'], data['company_link'],
                    data['salary'], data['experience'], data['age'], data['education'],
